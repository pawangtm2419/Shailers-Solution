import { Component, ElementRef, HostListener, Inject, Injectable, NgModule, Pipe } from '@angular/core';
...
SortComponent.propDecorators = {
    'onSortClick': [{ type: HostListener, args: ['click', ['$event'],] },],
};
...
SortPipe.decorators = [
    { type: Pipe, args: [{ name: 'sort', pure: false },] },
];
/**
 * @nocollapse
 */
SortPipe.ctorParameters = function () { return [
    { type: SortService, decorators: [{ type: Inject, args: [SortService,] },] },
]; };
...
export { AppModule, SortService, AppComponent as ɵa, SortComponent as ɵb, SortPipe as ɵc };
//# sourceMappingURL=ng-sort.es5.js.map
